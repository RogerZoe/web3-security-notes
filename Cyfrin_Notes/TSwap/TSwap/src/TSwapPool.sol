...
// say output amount is 10 WETH, and inputReserves is 1000 WETH, and outputReserves is 1000 DAI, then we want to figure out how much DAI we need ?
// then it will return 10 DAI.
    function getInputAmountBasedOnOutput( 
        uint256 outputAmount, // 10 DAI
        uint256 inputReserves, // 1000 WETH
        uint256 outputReserves // 1000 DAI
    )
        public
        pure
...
// this funcytion works like taking , INFO: “I want to swap 100 DAI. How much WETH can I get?”
    ...
    //  INFO: “I need exactly 1 WETH to repay a loan. How much DAI must I pay?”
        ...
        returns (uint256 inputAmount)
    {
        ...
        // here there is no check for minInputAmount, it will affect  the swap .
