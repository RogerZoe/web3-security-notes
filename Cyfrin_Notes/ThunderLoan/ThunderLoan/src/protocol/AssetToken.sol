...
contract AssetToken is ERC20 {
  ...
  // @audit-info  may have weird ERC20's ? USDC is a weird one in this case .
    function transferUnderlyingTo(address to, uint256 amount) external onlyThunderLoan {
        i_underlying.safeTransfer(to, amount);
    }


// Exchange rate must only move when the vault’s real balance changes due to profit or loss — never due to promises
